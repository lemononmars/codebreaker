...
<div class="max-w-4xl mx-auto py-8 px-4">
   <div class="flex flex-row justify-between items-center mb-4">
      <h1 class="text-4xl font-black">Missing Vowels</h1>
      <a href="/tools/missingvowels" class="btn btn-primary gap-2">
         ...
         <table class="table table-zebra table-compact w-full mx-auto">
            ...
            <tbody>
               {#each puzzles as p}
                  <tr>
                     <td>
                        <a href="/puzzles/missingvowels/{p.uid}">
                     ...
                     <td>
                        {#each p.tags || [] as t}
                           <div class="badge badge-outline mr-1">{t}</div>
                        {/each}
                     </td>
                  </tr>
               {/each}
