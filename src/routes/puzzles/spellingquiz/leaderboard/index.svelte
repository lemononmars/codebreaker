<script lang="ts">
	...
	import { ArrowLeftIcon, AwardIcon, TrophyIcon } from 'svelte-feather-icons';
...
<svelte:head>
	...
	<meta name="description" content="ตารางคะแนนสูงสุดส่วนตัว เกมสะกดศัพท์ แยกตามวิธีเล่นและโหมด" />
</svelte:head>
		...
		<div class="flex flex-col gap-1">
			<div class="flex items-center gap-3">
				...
				<div>
					...
					<p class="text-xs sm:text-sm opacity-60 font-semibold">เกมสะกดศัพท์ — คะแนนสูงสุดส่วนตัว</p>
				</div>
			</div>
